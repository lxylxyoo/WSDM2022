...
if __name__ == "__main__":
    input_A_initial = pd.read_csv("data/test_csvs/input_A.csv", header=None)
    ...
    input_A_initial6_s.to_csv("data/processed/DatasetA_input_start_fill-1.csv", index=False)
    input_A_initial6_e.to_csv("data/processed/DatasetA_input_end_fill-1.csv", index=False)