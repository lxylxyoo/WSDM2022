...
if __name__ == "__main__":
    input_B_initial = pd.read_csv("data/final_test_csvs/input_B.csv", header=None)
    ...
    input_B_initial_s.to_csv("data/processed/DatasetB_final_start.csv", index=False, header=False)
    input_B_initial_e.to_csv("data/processed/DatasetB_final_end.csv", index=False, header=False)