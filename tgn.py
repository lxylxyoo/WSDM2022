...
class TGN(nn.Module):
    def __init__(self,
        ...
        self.memory_updater_type = memory_updater_type  # gru, lstm之类的
        self.num_nodes = num_nodes
        self.feat_emb_A = feat_emb_A
    ...
    def update_memory(self, subg):
        new_g = self.memory_ops(
                        subg, 
                        self.embedding_attn.feat_emb_list if self.feat_emb_A else None, 
        )
    ...
    def reset_memory(self, device):
        self.memory.reset_memory(device)
